...
# Page title
st.markdown("""
# Bioactivity Prediction App (Beta Lactamase Ampc)
This app allows you to predict the bioactivity towards inhibting the `Beta-lactamase` enzyme. `Beta-lactamase` is a drug target for antibiotic resistance.
